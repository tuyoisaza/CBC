  ...
  return (
    <div className="wa-sticky">
      <a
        ...
        className="flex items-center justify-center gap-2 w-full rounded-xl bg-[#25D366] px-6 py-4 text-sm font-semibold text-white shadow-lg hover:bg-[#22c55e] transition-colors"
